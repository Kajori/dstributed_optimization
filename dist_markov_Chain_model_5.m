...
%         
        left_val= cal_outlier_individual_next_val(x,j,row,NO_AREA,deg,left,PRECISION);
        right_val= cal_outlier_individual_next_val(x,j,row,NO_AREA,deg,right,PRECISION);
